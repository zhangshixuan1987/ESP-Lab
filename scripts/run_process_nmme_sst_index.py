...
def _standardize_obs_index(da_anom: xr.DataArray, clim_start: int, clim_end: int) -> xr.DataArray:
    return standardize_index_anomaly(
        da_anom, clim_start, clim_end, time_dim="time", ensemble_dim=None
    )

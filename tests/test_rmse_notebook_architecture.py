...
NOTEBOOKS = (
    Path("jupyter/s2d_skill/1b_atm_leadtime_rmse_skill_map.ipynb"),
    Path("jupyter/s2d_skill/1b_ocn_leadtime_rmse_skill_map.ipynb"),
    Path("jupyter/s2d_skill/1c_atm_leadtime_rmse_compare.ipynb"),
    Path("jupyter/s2d_skill/1c_ocn_leadtime_rmse_compare.ipynb"),
)

LAND_NOTEBOOKS = (
    Path("jupyter/s2d_skill/1b_lnd_leadtime_rmse_skill_map.ipynb"),
    Path("jupyter/s2d_skill/1c_lnd_leadtime_rmse_compare.ipynb"),
)

# (skill-map notebook, compare notebook) pairs, one per realm.
REALM_PAIRS = (
    (Path("jupyter/s2d_skill/1b_atm_leadtime_rmse_skill_map.ipynb"), Path("jupyter/s2d_skill/1c_atm_leadtime_rmse_compare.ipynb")),
    (Path("jupyter/s2d_skill/1b_ocn_leadtime_rmse_skill_map.ipynb"), Path("jupyter/s2d_skill/1c_ocn_leadtime_rmse_compare.ipynb")),
)

...
<body>
    ...
    <script>
            ...
            list.forEach((fig, index) => {
                ...
                card.innerHTML = `
                    <div class="card-img-wrapper" onclick="openLightbox(${index})">
                        <img class="card-img" src="${fig.file}" alt="${fig.title}" loading="lazy">
        ...
        function openLightbox(index) {
            ...
            document.getElementById("lightboxDownloadBtn").href = fig.file;
            ...
            selectedForCompare.forEach((fig, index) => {
                ...
                panel.innerHTML = `
                    ...
                    <div class="comp-panel-body" id="compBody-${index}">
                        <img class="comp-panel-img" id="compImg-${index}" src="${fig.file}" alt="" draggable="false">
